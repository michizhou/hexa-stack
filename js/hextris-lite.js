...
function showHelp() {
    ...
    $("#inst_main_body").html("<div id = 'instructions_head'>HOW TO PLAY</div>"
        + "<p>The main goal of Hextris is to stop blocks from leaving the inside of the outer gray hexagon.</p><p>"
        ...
        + "<p>Time left before your combo streak disappears is shown by "
